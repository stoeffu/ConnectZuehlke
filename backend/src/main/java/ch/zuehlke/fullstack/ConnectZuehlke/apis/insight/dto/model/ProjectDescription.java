...
public class ProjectDescription {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, title, description, tasks, titleDe, descriptionDe, tasksDe, releaseStateEn, releaseStateDe, language, languageText, projectId, project, employeeProjectId, employeeProject, employeeId, employee, role, overrideOfficialDescription, skills);
    }
