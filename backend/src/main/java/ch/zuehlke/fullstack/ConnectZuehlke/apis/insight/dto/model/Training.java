...
public class Training {
    ...
    public Training _date(String _date) {
        this._date = _date;
        return this;
    }
    ...
    public Training date(String date) {
        this.date = date;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(_date, name, shortDescription, description, url, urlHint, ISBN, trainer, location, deprecated, type, typeText, level, levelText, averageRating, numberOfRatings, participants, costs, match, participations, skills, sources, attachment, date, sortDate, id);
    }
