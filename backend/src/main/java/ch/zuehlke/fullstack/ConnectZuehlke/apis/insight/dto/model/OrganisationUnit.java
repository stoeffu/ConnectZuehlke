...
public class OrganisationUnit {
    ...
    public OrganisationUnit lastUpdated(String lastUpdated) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, fullName, link, description, type, company, manager, parentId, parent, children, skills, participants, isGroup, sourceLink, lastUpdated, typeText);
    }
