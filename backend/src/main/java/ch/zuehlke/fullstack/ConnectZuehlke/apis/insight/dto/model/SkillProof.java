...
public class SkillProof {
    ...
    public SkillProof proofDate(String proofDate) {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(source, sourceText, project, endorsmentEmployee, isEndorsementApproved, proofDate, days, url, level, levelText, experience, description);
    }
