...
public class Contact {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(active, activeText, firstName, lastName, fullName, position, phone, mobilePhone, email, linkedIn, xing, department, responsibleEmployee, customer, id);
    }
