...
public class EmployeeTimelineItem {
    ...
    public EmployeeTimelineItem date(String date) {
        this.date = date;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(project, feedbackEmployee, date, year, type, typeText, title, description, completed, deleted, parentId, children, id);
    }
