...
public class Customer {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(vertecId, currency, wikipediaLink, name, description, descriptionDe, hasLogo, street, city, zip, country, longitude, latitude, responsible, role, roleText, type, typeText, parent, yearlyTurnovers, children, services, industry, id);
    }
