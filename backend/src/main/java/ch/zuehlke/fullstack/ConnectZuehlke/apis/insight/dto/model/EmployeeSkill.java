...
public class EmployeeSkill {
    ...
    public EmployeeSkill lastProof(String lastProof) {
    ...
    public void setLastProof(String lastProof) {
        this.lastProof = lastProof;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, shortDescription, description, lastProof, category, experience, experienceText, experiencePoints, sources, capability, isManagedSkill, isDisabled);
    }
