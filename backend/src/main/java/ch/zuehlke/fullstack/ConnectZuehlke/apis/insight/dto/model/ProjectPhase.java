...
public class ProjectPhase {
    ...
    public ProjectPhase createdDate(String createdDate) {
    ...
    public ProjectPhase soldDate(String soldDate) {
    ...
    public ProjectPhase offerDate(String offerDate) {
    ...
    public ProjectPhase lostDate(String lostDate) {
    ...
    public ProjectPhase from(String from) {
        this.from = from;
        return this;
    }
    ...
    public ProjectPhase to(String to) {
        this.to = to;
        return this;
    }
