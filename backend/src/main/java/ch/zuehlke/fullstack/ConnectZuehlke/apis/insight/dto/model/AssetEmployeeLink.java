...
public class AssetEmployeeLink {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(assetId, name, qualification, title, jobProfile, location, code, experiencePoints, description, source, project, experience, experienceText, role, sources, isDisabled, roleText, experienceRoleText, experienceRoleTextOrder, id);
    }
