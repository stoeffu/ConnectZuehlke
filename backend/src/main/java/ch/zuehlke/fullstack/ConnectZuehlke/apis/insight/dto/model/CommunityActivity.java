...
public class CommunityActivity {
    ...
    public CommunityActivity date(String date) {
        this.date = date;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, nameDe, url, date, description, descriptionDe, activityType, isHidden, isUserGenerated, activityTypeText);
    }
