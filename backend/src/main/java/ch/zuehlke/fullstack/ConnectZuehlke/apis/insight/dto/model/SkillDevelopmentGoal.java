...
public class SkillDevelopmentGoal {
    ...
    public SkillDevelopmentGoal until(String until) {
        this.until = until;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(skill, employee, noInvestment, noInvestmentReason, completed, targetExperienceLevel, targetExperienceLevelText, actions, trainingDays, projectDays, amount, until, id);
    }
