...
public class TrainingParticipation {
    ...
    public TrainingParticipation date(String date) {
        this.date = date;
        return this;
    }
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, rating, description, importName, date, employee, source, sourceText, attachment, training, trainingRecordId, year);
    }
